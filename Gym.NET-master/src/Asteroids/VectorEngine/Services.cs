...
namespace Asteroids_Deluxe.VectorEngine
{
    public sealed class Services : DrawableGameComponent
    {
        ...
        public static BackBuffer RenderTarget { get; set; }
        ...
        /// </summary>
        private Services(AsteroidGame game) : base(game)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(RenderTarget, new Microsoft.Xna.Framework.Rectangle(0, 0, (int)(m_GraphicsDM.PreferredBackBufferWidth),
                   (int)(m_GraphicsDM.PreferredBackBufferHeight)), Microsoft.Xna.Framework.Color.White);
        ...
        public static void Initialize(GraphicsDeviceManager graphics, AsteroidGame game)
        {
            ...
            if (m_Instance == null)
            {
                ...
                RenderTarget = new BackBuffer(game, graphics.GraphicsDevice, graphics.PreferredBackBufferWidth, graphics.PreferredBackBufferHeight, DepthFormat.Depth24Stencil8);
                RenderTarget.ResetRender(game, graphics.GraphicsDevice.PresentationParameters.Bounds);
