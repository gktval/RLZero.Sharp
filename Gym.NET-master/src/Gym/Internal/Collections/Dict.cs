...
namespace Gym.Collections {
    ...
    public class Dict : Dictionary<string, object>, IMergable<IDictionary>, IMergable<IList>, IMergable<IMergable> {
        ...
        public Dict(IDictionary<string, object> dictionary) : base(dictionary) { }

        public Dict(IEnumerable<KeyValuePair<string, object>> keyValuePairs) {
            foreach (var pair in keyValuePairs) {
                Add(pair.Key, pair.Value);
            }
        }

        public Dict(IDictionary<string, object> dictionary, IEqualityComparer<string> comparer) : base(dictionary, comparer) { }
        ...
        public int SetWhere(Func<KeyValuePair<string, object>, (bool Set, object Value)> comparer) {
        ...
        /// <returns>The amount of matching predictions and successful updates</returns>
        public int SetWhere(Func<KeyValuePair<string, object>, bool> settingsComparer, Func<KeyValuePair<string, object>, object> valueFactory) {
