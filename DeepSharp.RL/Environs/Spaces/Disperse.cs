namespace DeepSharp.RL.Environs.Spaces
{
    ...
    public class Disperse : DigitalSpace
    {
        ...
        public Disperse(int length, torch.ScalarType dtype = torch.ScalarType.Int64,
        ...
        public Disperse(int length, long start, torch.ScalarType dtype = torch.ScalarType.Int64,
            DeviceType deviceType = DeviceType.CUDA, long seed = 1)
