...
using NumSharp;
using Asteroids_Deluxe;

namespace GymTest;

public class Asteroids : Environ<Space, Space>
{
    ...
    public AsteroidGame GymEnv { get; set; }
    public bool IsDone { get; set; }

    public Asteroids(DeviceType deviceType = DeviceType.CUDA, int maxEpisodes = 500, bool isImage = true)
        : base("Asteroids", deviceType)
    {
        Initialise();
